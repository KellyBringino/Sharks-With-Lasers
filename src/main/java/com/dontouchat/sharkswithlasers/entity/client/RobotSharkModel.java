...
public class RobotSharkModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    private final ModelPart CollarPoint;

    public RobotSharkModel(ModelPart root) {
        ...
        this.CollarPoint = this.torso.getChild("CollarPoint");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Wires_r1 = torso.addOrReplaceChild("Wires_r1", CubeListBuilder.create().texOffs(80, 28).addBox(-1.0F, -4.0F, 0.0F, 5.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.0F, -10.0F, -6.0F, -0.5236F, -0.5236F, 0.0F));
        ...
        PartDefinition CollarPoint = torso.addOrReplaceChild("CollarPoint", CubeListBuilder.create(), PartPose.offset(0.0F, -5.0F, -6.0F));
    ...
    public ModelPart getCollarPoint(){return body;}
}