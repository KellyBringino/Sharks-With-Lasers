...
public class RobotSharkEntity extends SharkEntity{
    private SoundEvent chompSound = ModSounds.ROBOT_SHARK_CHOMP.get();
    private SoundEvent sharkSound = ModSounds.ROBOT_SHARK_SHARK.get();
    private SoundEvent ouchSound = ModSounds.ROBOT_SHARK_OUCH.get();
    private SoundEvent deathSound = ModSounds.ROBOT_SHARK_DEATH.get();
    ...
    protected @Nullable SoundEvent getAmbientSound() {
        return level().getRandom().nextBoolean() ? sharkSound : chompSound;
    }
